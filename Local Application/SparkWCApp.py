...
def Main(folderName, inputFolder, sampleName):

    # location of input sample files
    sampleInputPath = os.path.join(folderName, inputFolder, sampleName)
...
if __name__ == "__main__":
    ...
    Main(args.folderName, args.inputFolder, args.sampleName)
